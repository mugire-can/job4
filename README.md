...
This project encompasses 12 practical exercises focused on learning Python functions, control structures (if/elif/else), and basic programming logic. It's part of the "La Plateforme" curriculum.
...
1. **Run the complete project:**
   ```bash
   python "Projet jour 4.py"
   ```

2. **View exercise results:**
   - Each job executes automatically and prints output

3. **Modify exercises:**
   - Edit the corresponding job section in the Python file
...
**GitHub:** [mugire-can/job4](https://github.com/mugire-can/job4)  
**Default Branch:** main  
...
```bash
# Clone repository
git clone https://github.com/mugire-can/job4.git
...
*La Plateforme - Python Learning Curriculum*
